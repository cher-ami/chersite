...
[Sass](https://sass-lang.com) is used as css preprocessor. It can be set as `.scss` file or `.module.scss` for css module;
...
### <a name="BemForModuleSass"></a>BEM for `.module.scss`
...
### <a name="BemForSass"></a>BEM for `.scss`
